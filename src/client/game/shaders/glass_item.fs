...
void main() {
  ...
  // Use Base BRDF
  BaseMaterialProperties matProperties = BaseMaterialProperties(texColor.rgb, metallic, roughness, texAo, emissive, normal, matAmbient, matDiffuse, defaultMatSpecular);
  ...
  outColor = texColor; // vec4(litColor, texColor.a);
