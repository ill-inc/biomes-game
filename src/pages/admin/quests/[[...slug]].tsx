...
const QuestGraph = dynamic<{}>(
  () =>
    import("@/client/components/admin/quests/QuestGraph").then(
      (mod) => mod.QuestGraph
    ),
...
export const ChallengesEditor: React.FunctionComponent<
    ...
    <AdminPage>
      {bikkieLoaded && (
        <BikkieEditorWrapper
          ...
          setSelectedId={(id) => {
            void router.push(`/admin/quests/${id}`);
          }}
        >
